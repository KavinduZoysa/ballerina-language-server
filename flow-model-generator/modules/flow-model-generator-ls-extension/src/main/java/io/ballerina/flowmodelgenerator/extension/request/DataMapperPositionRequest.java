 ...
 * @param port      The target port that needs to consider to get the position
 *
 * @since 2.0.0
 */
public record DataMapperPositionRequest(String filePath, JsonElement flowNode, LinePosition position, String propertyKey,
                                        String port) {
}
